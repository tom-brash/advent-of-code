'''
Day 10-2: Tracking the movement of stars

An advent of code first (for me) - this code is identical to 10-1, with no
modifications needed. The answer for this (the number of steps required) was
already built in to the previous code.
'''

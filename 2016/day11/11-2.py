...
class Tower:
    def __init__(self, input_data):
        ...
        for i in range(1, 5):
            ...
            if i == 1:
                self.start_floors[i].extend(['elerium generator', 'elerium-compatible', 'dilithium generator', 'dilithium-compatible'])
    ...
    def find_best_path(self):
        ...
        while sq:
            ...
            # get previous fastest time to this state
            previous_best = best_states.get((loc, floor_string), 1000000)
            
            # if this isn't the fastest time, prune branch
            if d >= previous_best:
                continue
            # otherwise save the state as the fastest

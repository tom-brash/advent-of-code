...
class Scanner:
    def __init__(self, n, beacons):
        ...
        #     self.beacons.append([[a * b for a, b in zip(orientation, beacon)] for beacon in beacons])
        #     rot_beacons = [[z, x, y] for [x, y, z] in beacons]
        #     self.beacons.append([[a * b for a, b in zip(orientation, beacon)] for beacon in rot_beacons])
        #     rot_beacons = [[y, z, x] for [x, y, z] in beacons]
        #     self.beacons.append([[a * b for a, b in zip(orientation, beacon)] for beacon in rot_beacons])
    ...
    def roll(self, v): return (v[0],v[2],-v[1])
    def turn(self, v): return (-v[1],v[0],v[2])
    def sequence (self, v):

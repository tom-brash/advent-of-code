...
def main():
    ...
    # pq = [(1 * get_manhattan(start, target), start, 0)]
    # heapq.heapify(pq)
    ...
    #     if y < 5:
    #         print(pq)
    #     optimistic, pos, t = heapq.heappop(pq)
    #     d = get_manhattan(pos, target)
    #     if y % 10000 == 0:
    #         print(y, d, t)
    #     if d < closest:
    #         closest = d
    #     if t + optimistic > best_found:
    #         continue
    #     if pos == target and t <= best_found:
    #         print(f'Solution found at time {t}')
    #         best_found = t
    #         print(valley.clear[t])
    #         break

    #     best_pos = best_states.get(pos, 1000)
    #     if t - 10 > best_pos:
    #         continue
    #     if t < best_pos:
    #         best_states[pos] = t
            
    #     # best = best_at_t.get(t, 1000)
    #     # if t > 20 and d > (best + 5) * 1.3:
    #     #     print('hi')
    #     #     continue
    #     # if d < best:
    #     #     best_at_t[t] = d
        
    #     new_moves = get_valid_moves(pos, t, target, valley)
